const createSjwp = (): string[] => {
    ...
    return [
        ...
        `&nbsp;&nbsp;<span class='${ARROW_COLOR} ${SHADOW}'>→</span>&nbsp;<a href="repozitorij/3. razred/SJWP/LV20.pdf" target="_blank">LV20 - CSS layout</a>`,
        `&nbsp;&nbsp;<span class='${ARROW_COLOR} ${SHADOW}'>→</span>&nbsp;<a href="repozitorij/3. razred/SJWP/LV21.docx" target="_blank">LV21 - Pseudoklase i pseudoelementi</a>`,
        "<br>",
