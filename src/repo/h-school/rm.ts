const createRm = (): string[] => {
    ...
    return [
        ...
        `&nbsp;&nbsp;<span class='${ARROW_COLOR} ${SHADOW}'>→</span>&nbsp;<a href="repo - sadržaj/3. razred/RM/LV06.docx" target="_blank">LV06 - Konzolni pristup i temeljna konfiguracija usmjernika</a>`,
        "<br>",
