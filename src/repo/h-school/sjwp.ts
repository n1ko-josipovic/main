const createSjwp = (): string[] => {
    ...
    return [
        ...
        `&nbsp;&nbsp;<span class='${ARROW_COLOR} ${SHADOW}'>→</span>&nbsp;<a href="repo - sadržaj/3. razred/SJWP/LV06.pdf" target="_blank">LV06 - HTML stilovi, poveznice i slike</a>`,
        `&nbsp;&nbsp;<span class='${ARROW_COLOR} ${SHADOW}'>→</span>&nbsp;<a href="repo - sadržaj/3. razred/SJWP/LV07.pdf" target="_blank">LV07 - Liste i tablice</a>`,
        `&nbsp;&nbsp;<span class='${ARROW_COLOR} ${SHADOW}'>→</span>&nbsp;<a href="repo - sadržaj/3. razred/SJWP/LV08.pdf" target="_blank">LV08 - HTML obrasci</a>`,
        `&nbsp;&nbsp;<span class='${ARROW_COLOR} ${SHADOW}'>→</span>&nbsp;<a href="repo - sadržaj/3. razred/SJWP/LV09.pdf" target="_blank">LV09 - Meta elementi i putanje za datoteke</a>`,
        `&nbsp;&nbsp;<span class='${ARROW_COLOR} ${SHADOW}'>→</span>&nbsp;<a href="repo - sadržaj/3. razred/SJWP/LV10.pdf" target="_blank">LV10 - Multimedija</a>`,
        `&nbsp;&nbsp;<span class='${ARROW_COLOR} ${SHADOW}'>→</span>&nbsp;<a href="repo - sadržaj/3. razred/SJWP/LV11.pdf" target="_blank">LV11 - HTML Semantički elementi i izgled (Layout)</a>`,
        `&nbsp;&nbsp;<span class='${ARROW_COLOR} ${SHADOW}'>→</span>&nbsp;<a href="repo - sadržaj/3. razred/SJWP/LV12.pdf" target="_blank">LV12 - Izrada mrežnog sjedišta</a>`,
        "<br>",
        `&nbsp;&nbsp;&nbsp;<span class='${LOWLIGHTED}'>CSS</span>`,
        `&nbsp;&nbsp;<span class='${ARROW_COLOR} ${SHADOW}'>→</span>&nbsp;<a href="repo - sadržaj/3. razred/SJWP/LV14.docx" target="_blank">LV14 - Povezivanje HTML-a i CSS-a, vrste i sintaksa CSS-a</a>`,
        "<br>",
