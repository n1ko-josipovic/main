const createUurm = (): string[] => {
    ...
    return [
        ...
        `&nbsp;&nbsp;&nbsp;<span class='${ARROW_COLOR} ${SHADOW}'>→</span>&nbsp;<a href="arhiv/II. razred/UURM/LV04.pdf" target="_blank">LV04 - Osnovne mrežne postavke računala</a>`,
        `&nbsp;&nbsp;&nbsp;<span class='${ARROW_COLOR} ${SHADOW}'>→</span>&nbsp;<a href="arhiv/II. razred/UURM/LV05.pdf" target="_blank">LV05 - Izrada i ispitivanje mrežnih kabela</a>`,
